...
import pageObjects.DataPageAllure;
...
public class DataPageAllureTest extends DataPageTestBase {

    private DataPageAllure dataPage;

    @BeforeClass
    public void beforeClass() {
        dataPage = page(DataPageAllure.class);
    }
